...
export default function SpawnPoolGenerator() {
            ...
            const importedFile = {
              ...
              spawns: jsonContent.spawns.map((spawn, index) => {
                ...
                return {
                  ...
                  spawnablePositionType: spawn.spawnablePositionType || "grounded",
  ...
  function isSpawnDuplicate(spawn1, spawn2) {
    ...
    if (spawn1.spawnablePositionType !== spawn2.spawnablePositionType) return false;
  ...
  function buildJsonForFile(file) {
    const spawns = file.spawns.map((s, i) => {
      ...
      Object.assign(spawnObj, {
        type: "pokemon",
        spawnablePositionType: s.spawnablePositionType,
        bucket: s.bucket,
        level: levelStr,
                      ...
                      <div className="mt-3">
                        <div className="grid grid-cols-12 gap-3">
                          ...
                          <div className="col-span-3">
                            <label className="text-sm text-gray-300">
                              Spawnable Position Type
                            </label>
                            <select
                              value={s.spawnablePositionType}
                              onChange={(e) =>
                                updateSpawnField(
                                  activeFileIndex,
                                  si,
