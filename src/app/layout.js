...
import { BASE_PATH as basePath } from "@/utils/basePath";
...
export const metadata = {
  ...
  icons: {
    icon: `${basePath}/teto.jpg`,
    shortcut: `${basePath}/teto.jpg`,
    apple: `${basePath}/teto.jpg`,
  },
};
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link rel="icon" href={`${basePath}/teto.jpg`} />
        <link rel="shortcut icon" href={`${basePath}/teto.jpg`} />
        <link rel="apple-touch-icon" href={`${basePath}/teto.jpg`} />
      </head>
      <body
